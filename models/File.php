...
class File extends Base{
     public function getFiles($id){
      $sql = "SELECT f_lat lat,f_lng lng,f_slurl thumbnail,f_url url,f_video_url video,f_caption caption,f_event event,f_date_time data_time,f_address address,f_id id FROM `m_files` WHERE f_uid =$id AND f_isd='0'";
